...
const Hero = ({heroapi:{title,subtitle,btntext,img,sociallinks,videos}}) => {
  return (
    ...
    <div className='relative h-auto w-auto flex flex-col'>
        <div className='bg-theme clip-path h-[85vh] lg:[75vh] md:h-[65vh] sm:h-[55vh] w-auto absolute top-0 left-0 right-0 opacity-100 z-10'></div>
...
<div className=''>
    ...
    w-auto h-[45vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh]
    xsm:h-[19vh] transitions-theme -rotate-[25deg] hover:rotate-0 cursor-pointer object-fill
    '/>
</div>
